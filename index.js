...
// Hide the forecast container by default
forecastContainer.style.display = "none";
...
search.addEventListener("click", () => {
  ...
  // Hide the forecast container if input is empty
  if (city.trim() === "") {
    forecastContainer.style.display = "none";
    return;
  }
  ...
  fetch(
    ...
    .then((json) => {
      if (json.cod === "404") {
        ...
        weatherDetails.classList.remove("active");
        error404.classList.add("active");
        forecastContainer.style.display = "none"; // Hide on error
        return;
      }
      ...
      weatherDetails.classList.add("active");
      error404.classList.remove("active");
      forecastContainer.style.display = "block"; // Show on valid search
